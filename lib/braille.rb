...
class Braille
  ...
  attr_reader :file_chars_array, :line_1, :line_2, :line_3
  ...
  def read_in_file
    ...
    #Each arracy includes a carrgiage return! ex: ["....\n", "..00\n", "..0.\n"]
    @file_chars_array.flatten
  end
...
# braille = Braille.new
# puts @file_chars_array
# puts braille.read_in_file
